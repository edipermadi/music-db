...
func (s Type) FifthGeneratorRoot() Generator {
...
func (s Type) FifthGeneratorRootWithTonic(tonic pitch.Type) Generator {
	...
	return Generator{
		Orphan: orphanPitches,
		Left:   leftPitches,
		Center: centerPitches,
		Right:  rightPitches,
	}
}
...
// Generator is scale generator components
type Generator struct {
	Orphan []pitch.WithDegree
	Left   []pitch.WithDegree
	Center []pitch.WithDegree
	Right  []pitch.WithDegree
}

func (g Generator) Root() pitch.WithDegree {
	if len(g.Left) == 1 {
		return g.Left[0]
	}
...
func (g Generator) Edge() pitch.WithDegree {
	if len(g.Right) == 1 {
		return g.Right[0]
	}
